...
$route['controlUser'] = 'ControlUsuario/ControlUsuarios';
$route['updateUser/(:num)'] = 'ControlUsuario/ControlUpdateUser/index/$1';
$route['guardarUser'] = 'ControlUsuario/ControlUpdateUser/GuardarUser';
